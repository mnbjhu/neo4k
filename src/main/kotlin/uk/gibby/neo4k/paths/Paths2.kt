...
data class NeoPath2<A : ReturnValue<*>, B : ReturnValue<*>, C : ReturnValue<*>>(
    val first: A,
    val firstToSecond: B,
    val second: C,
    val ref: String
...
class NoDirOpenPath2<A : Node<*>, B : NonDirectionalRelationship<A, *>>(
    val first: Searchable<A>,
    val firstToSecond: RelationParamMap<B>
)

class ForwardOpenPath2<A : Node<*>, B : DirectionalRelationship<A, C, *>, C : Node<*>>(
    val first: Searchable<A>,
    val firstToSecond: RelationParamMap<B>
)

class BackwardsOpenPath2<A : Node<*>, B : DirectionalRelationship<A, C, *>, C : Node<*>>(
    val first: Searchable<C>,
    val firstToSecond: RelationParamMap<B>
)
