...
class NeoMatchablePath4<A : Node<*>, B : Relationship<*, *, *>, C : Node<*>, D : Relationship<*, *, *>, E : Node<*>, F : Relationship<*, *, *>, G : Node<*>>(
    ...
    override fun getReference() = NeoPath4(
        first.getReference(),
...
infix fun <A : Node<*>, B : Relationship<*, *, *>,
        C : Node<*>, D : Relationship<*, *, *>,
        E : Node<*>, F : DirectionalRelationship<E, G, *>,
        G : Node<*>> NeoMatchablePath3<A, B, C, D, E>.`o-→`(relation: RelationParamMap<F>) = ForwardOpenPath4(
    first,
    firstToSecond,
    firstToSecondDir,
    second,
...
infix fun <A : Node<*>, B : Relationship<*, *, *>,
        C : Node<*>, D : Relationship<*, *, *>,
        E : Node<*>, F : DirectionalRelationship<E, G, *>,
        G : Node<*>> NeoMatchablePath3<A, B, C, D, E>.`o-→`(relation: KFunction<F>) = ForwardOpenPath4(
    first,
    firstToSecond,
    firstToSecondDir,
    second,
...
infix fun <A : Node<*>, B : Relationship<*, *, *>,
        C : Node<*>, D : Relationship<*, *, *>,
        E : Node<*>, F : DirectionalRelationship<G, E, *>,
        G : Node<*>> NeoMatchablePath3<A, B, C, D, E>.`←-o`(relation: RelationParamMap<F>) = BackwardsOpenPath4(
    first,
    firstToSecond,
    firstToSecondDir,
    second,
...
infix fun <A : Node<*>, B : Relationship<*, *, *>,
        C : Node<*>, D : Relationship<*, *, *>,
        E : Node<*>, F : DirectionalRelationship<G, E, *>,
        G : Node<*>> NeoMatchablePath3<A, B, C, D, E>.`←-o`(relation: KFunction<F>) = BackwardsOpenPath4(
    first,
    firstToSecond,
    firstToSecondDir,
    second,
...
infix fun <A : Node<*>, B : Relationship<*, *, *>,
        C : Node<*>, D : Relationship<*, *, *>,
        E : Node<*>, F : NonDirectionalRelationship<E, *>> NeoMatchablePath3<A, B, C, D, E>.`-o-`(relation: RelationParamMap<F>) =
    NoDirOpenPath4(
        first,
        firstToSecond,
        firstToSecondDir,
...
infix fun <A : Node<*>, B : Relationship<*, *, *>,
        C : Node<*>, D : Relationship<*, *, *>,
        E : Node<*>, F : NonDirectionalRelationship<E, *>> NeoMatchablePath3<A, B, C, D, E>.`-o-`(relation: KFunction<F>) =
    NoDirOpenPath4(
        first,
        firstToSecond,
        firstToSecondDir,
...
infix fun <A : Node<*>, B : Relationship<*, *, *>,
        C : Node<*>, D : Relationship<*, *, *>,
        E : Node<*>, F : DirectionalRelationship<G, E, *>,
        G : Node<*>> BackwardsOpenPath4<A, B, C, D, E, F, G>.`←-o`(node: Searchable<G>) = NeoMatchablePath4(
    first,
    firstToSecond,
    firstToSecondDir,
    second,
...
infix fun <A : Node<*>, B : Relationship<*, *, *>,
        C : Node<*>, D : Relationship<*, *, *>,
        E : Node<*>, F : DirectionalRelationship<G, E, *>,
        G : Node<*>> BackwardsOpenPath4<A, B, C, D, E, F, G>.`←-o`(node: KFunction<G>) = NeoMatchablePath4(
    first,
    firstToSecond,
    firstToSecondDir,
    second,
...
infix fun <A : Node<*>, B : Relationship<*, *, *>,
        C : Node<*>, D : Relationship<*, *, *>,
        E : Node<*>, F : DirectionalRelationship<G, E, *>,
        G : Node<*>> BackwardsOpenPath4<A, B, C, D, E, F, G>.`←-o`(node: G) = NeoMatchablePath4(
    first,
    firstToSecond,
    firstToSecondDir,
    second,
...
infix fun <A : Node<*>, B : Relationship<*, *, *>,
        C : Node<*>, D : Relationship<*, *, *>,
        E : Node<*>, F : DirectionalRelationship<E, G, *>,
        G : Node<*>> ForwardOpenPath4<A, B, C, D, E, F, G>.`o-→`(node: Searchable<G>) = NeoMatchablePath4(
    first,
    firstToSecond,
    firstToSecondDir,
    second,
...
infix fun <A : Node<*>, B : Relationship<*, *, *>,
        C : Node<*>, D : Relationship<*, *, *>,
        E : Node<*>, F : DirectionalRelationship<E, G, *>,
        G : Node<*>> ForwardOpenPath4<A, B, C, D, E, F, G>.`o-→`(node: KFunction<G>) = NeoMatchablePath4(
    first,
    firstToSecond,
    firstToSecondDir,
    second,
...
infix fun <A : Node<*>, B : Relationship<*, *, *>,
        C : Node<*>, D : Relationship<*, *, *>,
        E : Node<*>, F : DirectionalRelationship<E, G, *>,
        G : Node<*>> ForwardOpenPath4<A, B, C, D, E, F, G>.`o-→`(node: G) = NeoMatchablePath4(
    first,
    firstToSecond,
    firstToSecondDir,
    second,
...
infix fun <A : Node<*>, B : Relationship<*, *, *>,
        C : Node<*>, D : Relationship<*, *, *>,
        E : Node<*>, F : NonDirectionalRelationship<E, *>> NoDirOpenPath4<A, B, C, D, E, F>.`-o-`(node: Searchable<E>) =
    NeoMatchablePath4(
        first,
        firstToSecond,
        firstToSecondDir,
...
infix fun <A : Node<*>, B : Relationship<*, *, *>,
        C : Node<*>, D : Relationship<*, *, *>,
        E : Node<*>, F : NonDirectionalRelationship<E, *>> NoDirOpenPath4<A, B, C, D, E, F>.`-o-`(node: KFunction<E>) =
    NeoMatchablePath4(
        first,
        firstToSecond,
        firstToSecondDir,
...
infix fun <A : Node<*>, B : Relationship<*, *, *>,
        C : Node<*>, D : Relationship<*, *, *>,
        E : Node<*>, F : NonDirectionalRelationship<E, *>> NoDirOpenPath4<A, B, C, D, E, F>.`-o-`(node: E) =
    NeoMatchablePath4(
        first,
        firstToSecond,
        firstToSecondDir,
